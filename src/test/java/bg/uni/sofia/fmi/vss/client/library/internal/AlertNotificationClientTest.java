...
import bg.uni.sofia.fmi.vss.client.library.model.*;
...
import bg.uni.sofia.fmi.vss.client.library.CustomerResourceEventBuilder;
...
public class AlertNotificationClientTest {
    ...
    private static final ServiceRegion TEST_SERVICE_REGION = new ServiceRegion(new Platform("platform"), "https://example.com");
